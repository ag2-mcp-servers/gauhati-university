...
class CertificateParameters(BaseModel):
    APPL_NO: str = Field(..., description='Application No', examples=['A18xxxxxx'])
    DOB: str = Field(..., description='Date of birth', examples=['01-01-2001'])
    FullName: str = Field(..., description='Name', examples=['Ashish Ranjan'])
    SESSION: str = Field(..., description='Session', examples=['2018 - 2019'])
